...
public class WaterMeterReadingSystemInterfaceProcess implements InterfaceCommon {
    ...
    public WaterMeterReadingSystemInterfaceProcess(){}
    public WaterMeterReadingSystemInterfaceProcess(String interfaceId,
                                                   HttpBaseInfoMapper httpBaseInfoMapper,
                                                   HeadersMapper headersMapper,
                                                   ParametersMapper parametersMapper,
                                                   TokensMapper tokensMapper,
...
//            String systemId = "watermeterreading_system";
            ...
            if(parametersModels!=null && !parametersModels.isEmpty()){
                ...
                parameters.put("start_time",sdf.format(calendar.getTime()));
            }
