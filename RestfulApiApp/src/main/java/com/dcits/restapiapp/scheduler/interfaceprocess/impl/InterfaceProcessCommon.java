...
import com.dcits.restapiapp.model.*;
...
public class InterfaceProcessCommon implements InterfaceCommon {
    ...
    public InterfaceProcessCommon(){}
    public InterfaceProcessCommon(String interfaceId,
                                  HttpBaseInfoMapper httpBaseInfoMapper,
                                  HeadersMapper headersMapper,
                                  ParametersMapper parametersMapper,
                                  TokensMapper tokensMapper,
